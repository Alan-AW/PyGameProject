...
class Info():
    ...
    def create_state_labels(self):
        ...
        if self.state == 'main_menu':
            ...
            self.state_labels.append((self.create_label('TOP - '), (320, 460)))
            self.state_labels.append((self.create_label('000000'), (430, 460)))
    ...
    def create_label(self, label, size = 40, width_scale = 1.25, height_scale = 1):
        ...
        label_image = font.render(label, 1, (255,182,193))
    ...
    def draw(self, surface):
        ...
        # surface.blit(self.create_label('hello diao mao', size=60), (250, 500))
